...
const BookmarkPage = () => {
  ...
  // Categories for tabs
  const categories = [
    { id: "all", name: "All Bookmarks", icon: <Bookmark size={14} /> },
    { id: "health", name: "Health", icon: <Star size={14} /> },
    { id: "agriculture", name: "agriculture", icon: <Star size={14} /> },
    { id: "politics", name: "Politics", icon: <Star size={14} /> }
  ];
            ...
            {bookmarks.map((bookmark, index) => (
              <div 
                ...
                className={`
                  ...
                  ${bookmark.featured ? 'ring-4 ring-[#7585ff]/30 ring-offset-2' : ''}
                  relative
                `}
                ...
                <div className="p-6 flex-grow flex flex-col relative z-10">
                  ...
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <div className="flex items-center text-xs text-[#383838]/70 font-medium">
                      ...
                      <span className="inline-block">{bookmark.readingTime}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between items-center text-sm mb-4">
                    <div className="flex items-center text-[#383838]/70">
                      ...
                      <span className="inline-block font-medium">{bookmark.author}</span>
                    </div>
                    
                    <div className="flex items-center text-[#383838]/70">
                      <Calendar size={15} className="mr-1.5 text-[#7585ff]" />
                      <span className="inline-block font-medium">{bookmark.date}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between items-center mt-4 pt-4 border-t border-gray-100 relative">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      {/* <Tooltip text="Favorite">
                        <button className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 text-[#383838]/70 hover:bg-[#51a31d]/10 hover:text-[#51a31d] transition-all duration-500 transform hover:scale-110 hover:rotate-3 shadow-sm hover:shadow-md">
                          <Heart size={16} className="transition-transform duration-500 group-hover:rotate-360" />
                        </button>
                      </Tooltip>
